...
public class PassengerRideInfoTest {

    @Test
    public void testPassengerRideToPassengerRideInfoDTO() {
        ...
        PassengerRideInfoDTO dto = PassengerRideInfoMapper.INSTANCE.passengerRideToPassengerRideInfoDTO(passengerRide);
        toDtoChecker(passengerRide, dto);

    }
    @Test
    public void testPassengerRideToPassengerRideInfoDTOs() {
        ...
        List<PassengerRideInfoDTO> dtos = PassengerRideInfoMapper.INSTANCE.passengerRideToPassengerRideInfoDTOs(passengerRides);
        for(int i=0; i<passengerRides.size(); i++){
            toDtoChecker(passengerRides.get(i), dtos.get(i));
        }
    }
    public void toDtoChecker(PassengerRide passengerRide, PassengerRideInfoDTO dto){
